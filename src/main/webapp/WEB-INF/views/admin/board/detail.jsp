...
<body>
    ...
    <main>
        ...
        <div class="board-wrapper">
			...
			<form id="moveForm" action="${pageContext.servletContext.contextPath}/admin/board/detail" method="get">
				<input type="hidden" name="boardNo" value="${board.boardNo}">
    ...
    $("#addCommentForm").submit(function(event) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/board/comment/add",
            type: "POST",
            data: formData,
            success: function(response) {
                if (response === 'success') {
    ...
    function submitEdit(commentNo) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/board/comment/modify",
            type: "POST",
            data: {
                commentNo: commentNo,
    ...
    function deleteComment(commentNo, boardNo) {
        if (confirm("정말로 이 댓글을 삭제하시겠습니까?")) {
            $.ajax({
                url: "${pageContext.request.contextPath}/admin/board/comment/delete",
                type: "POST",
