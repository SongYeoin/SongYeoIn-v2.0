			...
			<form
				...
				<div>
					<label for="journalTitle">제목:</label> <input type="text"
						...
						value="${journal.journalTitle}" required /> <span
						id="warn_journalTitle" class="warning">제목을 입력해주세요.</span>
				</div>

				<div>
					<label for="journalWriteDate">작성일자:</label> <input type="date"
						id="journalWriteDate" name="journalWriteDate"
						value="${journal.journalWriteDate}" required /> <span
						id="warn_date" class="warning">작성일자를 입력해주세요.</span>
				</div>

				<div>
					<label for="file">첨부파일:</label> <input type="file" id="file"
						name="file" /> <span id="warn_file" class="warning">첨부파일을
						선택해주세요.</span>
				</div>
