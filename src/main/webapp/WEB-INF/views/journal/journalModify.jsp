        ...
        <div class="box">
            ...
            <form
                ...
                <div>
                    ...
                    <span id="warn_journalTitle" class="warning">제목을 입력해주세요.</span>
                </div>
                ...
                <div>
                    ...
                    <span id="warn_date" class="warning">작성일자를 입력해주세요.</span>
                </div>

                <div>
                    <label for="file">첨부파일:</label> 
                    <input type="file" id="file" name="file" />
                    <span id="warn_file" class="warning">첨부파일을 선택해주세요.</span>
                </div>
